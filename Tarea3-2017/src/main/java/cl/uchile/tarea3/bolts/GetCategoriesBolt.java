 ...
 *
 */
public class GetCategoriesBolt extends BaseBasicBolt {

    private static final Logger LOG = LoggerFactory.getLogger(GetCategoriesBolt.class);
    ...
    public void execute(Tuple tuple, BasicOutputCollector collector) {
        try {
            ...
            while (products.hasNext()) {
                ...
                try {
                	String categoryName = product.get("category_name").toString();
                	if (!"".equals(categoryName)) {
                		System.out.println(categoryName);
                        //Emitimos los valores
                        collector.emit(new Values(categoryName));
                    }
            ...
            java.util.logging.Logger.getLogger(GetCategoriesBolt.class.getName()).log(Level.SEVERE, null, ex);
        } 
